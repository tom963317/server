...
public class SpCfgUtil {
	...
	public static Integer getInitCheckNum() {
		return Integer.parseInt(SpCfgUtil.getServerCfg("initCheck", "80"));
	}
	public static Integer getKsInitCheckNum() {
		return Integer.parseInt(SpCfgUtil.getServerCfg("ksInitCheck", "60"));
	}
	public static Long getOpenAccountNum() {
		return Long.valueOf(SpCfgUtil.getServerCfg("openAccountNum", "60"));
	}
	public static Long getKsOpenAccountNum() {
		return Long.valueOf(SpCfgUtil.getServerCfg("ksOpenAccountNum", "60"));
	}
	public static Long getDivDou() {
		return Long.valueOf(SpCfgUtil.getServerCfg("divDou", "0"));
	}
	public static Long getKsDivDou() {
		return Long.valueOf(SpCfgUtil.getServerCfg("ksDivDou", "0"));
	}
	public static Long initJudge() {
		return Long.valueOf(SpCfgUtil.getServerCfg("initJudge", "100"));
	}
	public static Long ksInitJudge() {
		return Long.valueOf(SpCfgUtil.getServerCfg("ksInitJudge", "100"));
	}
