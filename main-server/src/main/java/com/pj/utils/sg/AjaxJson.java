...
public class AjaxJson extends LinkedHashMap<String, Object> implements Serializable{
	...
	public static final int CODE_SUCCESS = 20000;			// 成功状态码
	public static final int CODE_ERROR = 40000;			// 错误状态码
	...
	public static AjaxJson getSuccess(int code,String msg, Object data) {
